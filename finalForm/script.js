...
function check(){
    console.log("hello");
    /*
   if(document.getElementById("uid_err").textContent == 'valid user id') {
       console.log("hello")
       if(document.getElementById('passwd_err').innerHTML == 'Valid password')
       if(document.getElementById('name_err').innerHTML == 'Valid username')
          if(document.getElementById('country_err').innerHTML == 'Country selected.')
              if( document.getElementById('zip_err').innerHTML == 'ZIP code entered')
                  if(document.getElementById('email_err').innerHTML == 'Valid email format')
                      if(document.getElementById('gender_err').innerHTML == 'Gender selected')    
                      window.location.href = "file:///D:/mini%20projects/finalForm/index2.html";
   }
     */ 
...
function zip_validation(){
        ...
        if(!zip_value.match(numbers) || zip_length !== 6)
            {
            document.getElementById('zip_err').innerHTML = 'You must enter a ZIP code, which must be numeric and must be at least 6 chracters long.';
            zip_name.focus();
